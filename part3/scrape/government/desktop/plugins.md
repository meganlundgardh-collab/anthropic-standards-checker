...
* Your administrators provision plugins for your organization, and some of them install automatically.
...
Claude for Government does not include a public plugin marketplace; your administrators provision your organization's plugins. You can also add a plugin marketplace of your own from **Browse plugins**. Your deployment's network controls determine whether a marketplace can be downloaded.
